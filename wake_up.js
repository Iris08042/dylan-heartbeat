...
const WAKE_FARM_TOOL = {
  ...
  function: {
    name: "farm_agent",
    description: "让独立的农场代理完成一轮默认授权的自主经营，并持续推进图鉴、探索、资源循环和伴侣合作。仅在你自主醒来并确实想做农场活动时调用；本轮想法只是优先事项，不要收窄成最低动作。农场代理会使用另一套专用模型。",
    parameters: {
      type: "object",
      properties: {
        instruction: { type: "string", description: "说明本轮优先事项、偏好和必要限制；无需重复申请自主经营授权" },
